# Generated by Django 5.1.8 on 2025-04-23 03:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                "indexes": [
                    models.Index(
                        fields=["comment"], name="vote_commen_comment_4a894b_idx"
                    ),
                    models.Index(
                        fields=["session_id"], name="vote_commen_session_b0451f_idx"
                    ),
                ],
                "constraints": [
                    models.UniqueConstraint(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "comment",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="vote.comment"
                    ),
                ),
                (
                    "user",
